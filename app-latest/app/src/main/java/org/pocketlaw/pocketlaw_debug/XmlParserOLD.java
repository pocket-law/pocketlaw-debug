...
//
//        // TODO: for income tax act again, kinda hacky
//        if (parser.getName().equals("FormulaDefinition")) {
//            isSkipping = "NONE (" + parser.getName() + " Saved)";
//            String section = "";
//            String pinpoint = "";
//            if ((parser.getAttributeValue(null, "Code")) != null) {
...
//                String regexStr = "^[0-9]*$";
    ...
    private void readFormulaDefinition(XmlPullParser parser, String section, String pinpoint) throws
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (parser.getName().equals("FormulaTerm")) {
                ...
                readFormulaOther(parser, section, pinpoint);
    ...
    private void readFormulaText(XmlPullParser parser, String section, String pinpoint) throws IOException, XmlPullParserException {
        ...
        String text = parser.getText();
        Log.e("XML", "db add readFormulaText ( 99, " + pinpoint + section + text + ")");
        Section resultObject = new Section(99, pinpoint, section, text);
        dbHelper.insertSectionDetail(resultObject);
//
//        Log.e("XML", "db add readFormulaText (  nothing doing for now )");
//
//        if (parser.next() == XmlPullParser.START_TAG) {
//            Log.e("XML", "parser.getName() in FormulaText: " + parser.getName());
//        }
    ...
    // For the tags FormulaText
    private void readFormulaOther(XmlPullParser parser, String section, String pinpoint) throws IOException, XmlPullParserException {

        parser.next();

        String text = parser.getText();
        Log.e("XML", "db add readFormulaOther ( 99, " + pinpoint + section + text + ")");
        Section resultObject = new Section(99, pinpoint, section, text);
        dbHelper.insertSectionDetail(resultObject);
//
//        Log.e("XML", "db add readFormulaOther (  nothing doing for now )");
////
//        if (parser.next() == XmlPullParser.START_TAG) {
//            skip(parser);
//        }
