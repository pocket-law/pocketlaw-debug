...
public class ActivityXmlOld extends AppCompatActivity {
    ...
    private class DownloadSectionXmlTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapterSection = new AdapterSection(ActivityXmlOld.this, R.layout.card_heading, sections);
    ...
    private class DownloadHeadingsXmlTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            mAdapterHeading = new AdapterHeading(ActivityXmlOld.this, R.layout.card_heading, headings);
